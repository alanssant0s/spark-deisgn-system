	...
	build: {
		lib: {
			entry: {
				...
				"date-picker": resolve(__dirname, "src/components/ui/date-picker.tsx"),
				...
				"context-menu": resolve(__dirname, "src/components/ui/context-menu.tsx"),
				...
				"toggle-group": resolve(__dirname, "src/components/ui/toggle-group.tsx"),
