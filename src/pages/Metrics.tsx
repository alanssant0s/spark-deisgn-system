              ...
              <div className="bg-card border border-card-border rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    ...
                    <StatusBadge status="active" text="Operacional" />
                  </div>
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    <span className="font-medium">Base de Dados</span>
                    <StatusBadge status="active" text="Saudável" />
                  </div>
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    <span className="font-medium">CDN</span>
                    <StatusBadge status="success" text="Otimizado" />
                  </div>
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    <span className="font-medium">Processamento</span>
                    <StatusBadge status="pending" text="Atualizando" />
                  </div>
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
