    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 relative transition-all duration-200 mx-auto"
        ),
        day_selected:
        ...
        day_today:
          "bg-accent text-accent-foreground font-semibold border border-primary/30",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-primary/10 aria-selected:text-muted-foreground",
        day_disabled:
          "text-muted-foreground opacity-30 cursor-not-allowed",
        day_range_middle:
          "aria-selected:bg-primary/20 aria-selected:text-foreground hover:aria-selected:bg-primary/30",
        day_range_start:
